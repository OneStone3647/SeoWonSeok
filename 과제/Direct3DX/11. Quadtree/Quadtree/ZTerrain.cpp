 ...
 *===================================================================================*/
HRESULT ZTerrain::Create(LPDIRECT3DDEVICE9 pDev, D3DXVECTOR3 * pvfScale, const char * lpBmpFilename, LPCWSTR lpTexFilename[MAX_TERRAIN_TEX])
{
	m_pd3dDevice = pDev;
	m_vfScale = *pvfScale;
...
HRESULT ZTerrain::BuildHeightMap(const char * lpFilename)
{
	...
	while (cxDIB / 2 != 0 || czDIB / 2 != 0)
	{
		...
		if ((cxDIB % 2 == 1 && cxDIB != 1) || (czDIB % 2 == 1 && czDIB != 1))
		{
			return E_FAIL;
		}
	}
